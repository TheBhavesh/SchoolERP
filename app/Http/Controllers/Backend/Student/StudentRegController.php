...
class StudentRegController extends Controller
{
 ...
 public function StudentUpdatePromotion(Request $request,$student_id){
	...
	public function StudentFeePaid($student_id){

		// dd($student_id);

		$data['id'] = $student_id;

    	return view('backend.student.student_reg.student_fee_paid',$data);
	...
	public function StudentFeestru($student_id){

		// dd($student_id);

		$data['id'] = $student_id;

    	return view('backend.student.student_reg.student_fee_stru',$data);
