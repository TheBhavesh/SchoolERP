...
Route::post('fee/stru/store', [FeeCategoryController::class, 'FeeStruStore'])->name('store.fee.stru');
...
Route::post('fee/paid/store', [FeeCategoryController::class, 'FeePaid'])->name('store.fee.paid');
Route::get('fee/paid/view', [FeeCategoryController::class, 'FeePaidView'])->name('student.fee.paid');
Route::get('fee/paid/pdf{date}', [FeeCategoryController::class, 'FeePaidViewPdf'])->name('student.fee.pdf');
...
Route::get('/reg/feepaid/{student_id}', [StudentRegController::class, 'StudentFeePaid'])->name('student.registration.feepaid');

Route::get('/reg/feestru/{student_id}', [StudentRegController::class, 'StudentFeestru'])->name('student.registration.feestru');
